...
tmpl.fill({ type: 'widgets', val: 20.2 }).uri === 'ordered/20.2+/widgets'
tmpl.fill({ type: 'widgets/foo', val: -3 }).uri === 'ordered/-3+/widgets%2Ffoo'


tmpl = path('/ordered/{ val:number }/{ type }')
assert.equal(tmpl.fill({ val: '20.2', type: 'widgets' }), null)